...
public class FloatComparisonPredicate implements IPredicate {
	...
	public FloatComparisonPredicate(int comparisonOperation, FloatExpression v1, FloatExpression v2) {
		this.comparisonOperation = comparisonOperation;
		this.v1 = v1;
		this.v2 = v2;
	}

	public FloatComparisonPredicate(FloatExpression v1, FloatExpression v2) {
		this(EQUAL_OP, v1, v2);
	}
