 ...
 */
public class Addition<T extends Number & Comparable<T>> implements IValueExpression<T> {
	...
	public Addition(IValueExpression ve1, IValueExpression ve2, IValueExpression... veArray) {
		_veList.add(ve1);
		_veList.add(ve2);
