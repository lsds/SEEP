...
public class CopyOfAggregation {
//	private static final long serialVersionUID = 1L;
//	private static Logger LOG = Logger.getLogger(CopyOfAggregation.class);
//
//	// the GroupBy type
...
//
//	public Aggregation(ValueExpression<T> ve, Map map) {
...
//
//	@Override
//	public CopyOfAggregation setDistinct(DistinctOperator distinct) {
//		_distinct = distinct;
//		return this;
//	}
//
...
//	@Override
//	public CopyOfAggregation<T> setGroupByColumns(List<Integer> groupByColumns) {
...
//
//	@Override
//	public CopyOfAggregation setGroupByProjection(ProjectOperator groupByProjection) {
