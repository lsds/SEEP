...
public class ThreeIdenticalQueries {
	...
	public static void main(String [] args) {
		...
		QueryConf queryConf3 = new QueryConf(Integer.parseInt(args[3]), 1024);
		...
		ITupleSchema schema3 = new TupleSchema (offsets1, 32);
			
		IMicroOperatorCode projCode3 = new Projection(
			new Expression [] {
				new LongColumnReference(0),
				new IntColumnReference(1),
				new IntColumnReference(2),
		...
		MicroOperator operator3 = new MicroOperator (projCode3, 2);
		Set<MicroOperator> operators3 = new HashSet<MicroOperator>();
		operators2.add(operator3);
		...
		System.out.println("3rd schema " + schema3.getByteSizeOfTuple() + " bytes");
