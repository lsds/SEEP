...
//		offsets2[0] = 12;
		...
		for (int i = 0; i < nestingDepth2; i++) {
			ex2_1 = new FloatDivision(new FloatMultiplication(new FloatConstant(3), ex2_1), new FloatConstant(2));
		}
