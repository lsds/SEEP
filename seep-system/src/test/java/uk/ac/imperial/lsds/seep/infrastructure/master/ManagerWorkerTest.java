...
/**
 * The class <code>ManagerWorkerTest</code> contains tests for the class <code>{@link ManagerWorker}</code>.
 *
 * @generatedBy CodePro at 18/10/13 19:08
 * @author rc3011
 * @version $Revision: 1.0 $
 */
public class ManagerWorkerTest extends TestCase {
	/**
	 * Run the ManagerWorker(Infrastructure,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 18/10/13 19:08
	 */
	public void testManagerWorker_1()
		throws Exception {
		Infrastructure inf = new Infrastructure(1);
		int port = 1;

		ManagerWorker result = new ManagerWorker(inf, port);
	...
	public void testRun_1()
		throws Exception {
		ManagerWorker fixture = new ManagerWorker(new Infrastructure(1), 1);
	...
	public static void main(String[] args) {
		if (args.length == 0) {
			...
			junit.textui.TestRunner.run(ManagerWorkerTest.class);
		} else {
			// Run only the named tests
			TestSuite suite = new TestSuite("Selected tests");
			for (int i = 0; i < args.length; i++) {
				TestCase test = new ManagerWorkerTest();
				test.setName(args[i]);
				suite.addTest(test);
			}
