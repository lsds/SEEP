...
//	private Map<Integer, MicroOperatorOLD> localDownstream;
//	private Map<Integer, MicroOperatorOLD> localUpstream;
//	
//	public static MicroOperatorOLD getSubOperator(OperatorCode code){
//		return new MicroOperatorOLD(code);
//	}
//	
//	private MicroOperatorOLD(OperatorCode code){
//		this.code = code;
//		this.mostDownstream = true;
//		this.mostUpstream = true;
//		this.localDownstream = new HashMap<Integer, MicroOperatorOLD>();
//		this.localUpstream = new HashMap<Integer, MicroOperatorOLD>();
//	}
//	
//	private void addLocalDownstream(int localStreamId, MicroOperatorOLD so){
...
//	}
//	
//	private void addLocalUpstream(int localStreamId, MicroOperatorOLD so){
...
//			MicroOperatorOLD target = localDownstream.entrySet().iterator().next().getValue();
...
//		MicroOperatorOLD target = localDownstream.get(streamId);
//		if(!target.isMostLocalDownstream()){
//			target.processData(dt, api);
//		}
//		else{
...
//	
//	@Override
//	public void connectSubOperatorTo(int localStreamId, MicroOperatorOLD so){
