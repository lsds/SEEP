...
public class SubQueryTaskCPUCallableOLD implements ISubQueryTaskCallable,  IWindowAPI {
	...
	private SubQueryTaskResultOLD result;
	...
	public SubQueryTaskCPUCallableOLD(ISubQueryConnectable subQueryConnectable, Map<Integer, IWindowBatch> windowBatches, int logicalOrderID, Map<SubQueryBufferWindowWrapper, Integer> freeUpToIndices) {
		...
		this.result = new SubQueryTaskResultOLD(logicalOrderID, freeUpToIndices);
	}
...
//	private Monitor monitor = new Monitor();
	...
	@Override
	public SubQueryTaskResultOLD call() throws Exception {
