...
bestEffortAcks=true
enableMeanderRouting=true
autoReconnectChannel=true
reconnectBackoff=100
#meanderRouting=weightedRoundRobin
meanderRouting=backpressure
replicatedSinksHashRouting=backpressure
#meanderRouting=hash
#meanderRouting=shortestPath
#boundMeanderRoutingQueues=true
boundMeanderRoutingQueues=false
