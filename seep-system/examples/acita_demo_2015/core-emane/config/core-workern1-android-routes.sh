...
# Master 
source demo_env.sh
echo "My android vars: $ANDROID_WORKER1_NET $VMCORE_WORKER1_VETH_IP $CORE_VMCORE_ETH"
ip route add $ANDROID_WORKER1_NET via $VMCORE_WORKER1_VETH_IP dev $CORE_VMCORE_ETH

#ip route add $ANDROID_MASTER_NET via $CORE_MASTER_IP dev $CORE_MANET_ETH 
echo "Other android vars: $ANDROID_WORKER2_NET $CORE_WORKER2_IP $CORE_MANET_ETH"
