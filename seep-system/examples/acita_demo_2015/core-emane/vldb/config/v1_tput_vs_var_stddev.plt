...
#set output plotname
set terminal term 
set output sprintf("%s/%s/tput_vs_%s_stddev%s",outputdir,timestr,varname,termext)
...
set style line 5 lw 5 lt 2 linecolor rgb BLACK 

set style data histograms
#set style histogram cluster gap 1
#set style histogram errorbars gap 2 lw 1
set style histogram errorbars gap 11 lw 5 
...
plot sprintf("%s/%s/all-k-tput.data",outputdir,timestr) using 2:4:xticlabels(3) ls 5 
