set terminal term 
set output sprintf("%s/%s/rel_latency_vs_mobility_stddev%s",outputdir,timestr,termext)

set title "Relative latency vs mobility for different replication factors (k)"
