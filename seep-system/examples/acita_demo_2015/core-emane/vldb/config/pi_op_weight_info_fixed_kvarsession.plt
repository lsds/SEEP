...
set output sprintf("%s/pi_op_weight_info_fixed_kvarsession_%s%s",expdir,timestr,termext)
...
plot sprintf("%s/tx_latencies.txt",expdir) using 1:2 notitle w lines linestyle 1
