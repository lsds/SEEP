...
plot sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 3 using ($2-0.25):8:7:12:10 w candlesticks whiskerbars 0.5 ls 4 title "BC", \
	''  index 2 using ($2-0.125):8:7:12:10 w candlesticks whiskerbars 0.5 ls 3 title "RR", \
	''  index 4 using ($2):8:7:12:10 w candlesticks whiskerbars 0.5 ls 5 title "P2C", \
	''  index 1 using ($2+0.125):8:7:12:10 w candlesticks whiskerbars 0.5 ls 2 title "WRR", \
	''  index 0 using ($2 > 1 ? $2+0.25 : $2):8:7:12:10 w candlesticks whiskerbars 0.5 ls 1 title "BP", \
	''  index 3 using ($2-0.25):9:9:9:9 notitle w candlesticks linestyle 6, \
	''  index 2 using ($2-0.125):9:9:9:9 notitle w candlesticks linestyle 6, \
	''  index 4 using ($2):9:9:9:9 notitle w candlesticks linestyle 6, \
	''  index 1 using ($2+0.125):9:9:9:9 notitle w candlesticks linestyle 6, \
	''  index 0 using ($2 > 1 ? $2+0.25 : $2):9:9:9:9 notitle w candlesticks linestyle 6

#plot sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 3 using 11:xtic(2) title "BC" ls 4, \
#plot sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 3 using 11:xtic(2) notitle ls -3, \
#	sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 3 using 2:8:7:12:10 w candlesticks whiskerbars 0.5 linestyle 4 title "BC", \
#	sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 2 using 11:xtic(2) title "RR" ls 3, \
#	sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 4 using 11:xtic(2) title "P2C" ls 5, \
#	sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 1 using 11:xtic(2) title "WRR" ls 2, \
#	sprintf("%s/%s/combined-all-k-lat.data",outputdir,timestr) index 0 using 11:xtic(2) title "BP" ls 1
