...
plot sprintf("%s/%s/1k-tput.data",outputdir,timestr) using 2:4:xtic(1) title "k=1" ls 1, \
	sprintf("%s/%s/2k-tput.data",outputdir,timestr) using 2:4:xtic(1) title "k=2" ls 2, \
	sprintf("%s/%s/3k-tput.data",outputdir,timestr) using 2:4:xtic(1) title "k=3" ls 3, \
	sprintf("%s/%s/5k-tput.data",outputdir,timestr) using 2:4:xtic('1') title "k=5" ls 4
