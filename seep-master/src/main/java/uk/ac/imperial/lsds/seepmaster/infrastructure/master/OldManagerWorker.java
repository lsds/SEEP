...
/**
 * LOG : Logger
inf : OldInfrastructure
managerS : ServerSocket
clientSocket : Socket
refPort : int
goOn : boolean
port : int
OldManagerWorker(OldInfrastructure, int)
crashCommand(String, String, String, String)
crashCommandParallelRecovery(String, String, String, String)
bootstrapCommand(String, int)
addOperatorCommand(String, String, String)
addPartitioningConnectionCommand(String[])
addDownstreamConnectionCommand(String[])
addUpstreamConnectionCommand(String[])
placeCommand(String[])
run()
 * @author ra
 *
...
public class OldManagerWorker implements Runnable {
...
//	final private Logger LOG = LoggerFactory.getLogger(OldManagerWorker.class);
//	
...
//	private int port;
//		
//	public OldManagerWorker(OldInfrastructure inf, int port){
//		this.inf = inf;
//		this.port = port;
//	}
//
