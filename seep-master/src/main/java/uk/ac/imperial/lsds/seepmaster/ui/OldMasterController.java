...
/**
 * LOG : Logger
instance : OldMasterController
ucl : URLClassLoader
OldMasterController()
getInstance()
inf : OldInfrastructure
eiu : ElasticInfrastructureUtils
submitQuery(LogicalSeepQuery)
start()
executeComposeFromQuery(String, String)
deployQueryToNodes()
getUserInput(String)
startSystemOption(OldInfrastructure)
configureSourceRateOption(OldInfrastructure)
parallelizeOpManualOption(OldInfrastructure, ElasticInfrastructureUtils)
