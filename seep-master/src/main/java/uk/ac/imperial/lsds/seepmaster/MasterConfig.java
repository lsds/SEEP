...
public class MasterConfig extends Config {
	...
	public static final String QUERY_FILE_DOC = "The file where user queries are specified";
	
	public static final String BASECLASS_NAME = "baseclass.name";
	public static final String BASECLASS_NAME_DOC = "The name of the Base class where the query is composed";
    ...
    private static final String LISTENING_PORT = "master.port";
