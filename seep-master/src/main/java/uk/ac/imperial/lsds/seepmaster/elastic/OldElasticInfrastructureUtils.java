 ...
 ******************************************************************************/
package uk.ac.imperial.lsds.seepmaster.elastic;


/**
 * 
 * uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.LOG
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.inf
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.rct
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.ucl
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.scalingMap
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.ElasticInfrastructureUtils(OldInfrastructure)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.ElasticInfrastructureUtils(...).new TimerTask() {...}
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.setClassLoader(URLClassLoader)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.promptForUserValidation(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.alert(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.unalert(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.alertCPU(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.unalertCPU(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.scaleOutOperator(int, int, Node)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.lightScaleOutOperator(int, int, Node)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.largeScaleOutOperator(int, int, Node)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.sendDistributedScaleOutMessageToStarTopology(int, int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.staticInstantiationNewReplicaOperators(QueryPlan)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.staticInstantiateNewReplicaOperator(ArrayList<ScaleOutIntentBean>, QueryPlan)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.staticScaleOut(int, int, Node, QueryPlan)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.executeStaticScaleOutFromIntent(ArrayList<ScaleOutIntentBean>)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.sendSystemConfiguredToReplica(Operator)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.sendResumeMessageToUpstreams(int, int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.sendScaleOutMessageToUpstreams(int, int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.executeParallelRecovery(String)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.addDownstreamConnections(Operator)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.addUpstreamConnections(Operator)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.addOperator(int, int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.getOperatorCode(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.configureStreamIdFromUpstreamOps(Operator, Operator, int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.configureStaticReplicaContext(int, Operator)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.configureOperatorContext(int, Operator)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.getOperatorClassName(int)
uk.ac.imperial.lsds.seepmaster.elastic.ElasticInfrastructureUtils.getNodeIdsForOperatorId(int)
 * @author ra
 *
 */

public class OldElasticInfrastructureUtils {
