...
echo "copy jar"
scp -i ../authEC2.pem ../../dist/SEEPv0.1-20130619.jar ubuntu@$INSTANCE:/home/ubuntu
echo "copy query"
scp -i ../authEC2.pem ../../../queries/cf-stream/dist/cf-stream.jar ubuntu@$INSTANCE:/home/ubuntu
